...
public class TvActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvId = intent.getStringExtra("TV_ID");
        ...
        if (networkInfo == null || !networkInfo.isConnected())
            ...
            new TvDetailsTask(progress).execute(this);
        }
    }
